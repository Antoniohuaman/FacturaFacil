// shared/ui/modal-anular-documento/ModalAnularDocumento.tsx
//
// Modal destructivo de anulación — genérico desde siempre (nunca dependió de
// `ComprobanteCompra`): recibe `motivos` como texto libre, por lo que sirve
// igual para Compras (`compras/componentes/modales/ModalAnularCompra.tsx`,
// que reexporta este mismo componente por compatibilidad) y para Gastos.
// Nunca una segunda implementación paralela del patrón destructivo.

import { useState } from 'react';
import { AlertTriangle, X } from 'lucide-react';

interface ModalAnularDocumentoProps {
  abierto: boolean;
  titulo: string;
  descripcion: string;
  motivos: string[];
