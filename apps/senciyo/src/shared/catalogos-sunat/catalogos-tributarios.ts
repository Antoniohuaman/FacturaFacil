...
export const CATALOGO_54_DETRACCIONES: CodigoDetraccionTributaria[] = [
  { catalogo: '54', codigo: '001', descripcion: 'Azúcar y melaza de caña', tipoOperacionRelacionado: '1001', clasificacion: 'Bien', porcentajeNormativo: 10, tipoPorcentaje: 'fijo', afectacionesCompatibles: ['gravado'], visible: true, activo: true, implementacion: 'pendiente' },
  { catalogo: '54', codigo: '002', descripcion: 'Arroz', tipoOperacionRelacionado: '1001', clasificacion: 'Bien', porcentajeNormativo: null, tipoPorcentaje: 'pendiente', notaPorcentaje: 'Validar si corresponde al IVAP/arroz pilado u otra tabla específica antes de usarlo en emisión.', afectacionesCompatibles: ['gravado'], visible: true, activo: true, implementacion: 'pendiente' },
  { catalogo: '54', codigo: '003', descripcion: 'Alcohol etílico', tipoOperacionRelacionado: '1001', clasificacion: 'Bien', porcentajeNormativo: 10, tipoPorcentaje: 'fijo', afectacionesCompatibles: ['gravado'], visible: true, activo: true, implementacion: 'pendiente' },
  { catalogo: '54', codigo: '004', descripcion: 'Recursos hidrobiológicos', tipoOperacionRelacionado: '1002', clasificacion: 'Recurso hidrobiológico', porcentajeNormativo: null, tipoPorcentaje: 'condicional', notaPorcentaje: 'SUNAT: 4% si el proveedor figura en el listado SUNAT y cumple condiciones; 10% en caso contrario. No usar tasa automática sin validar condición.', afectacionesCompatibles: ['gravado'], visible: true, activo: true, implementacion: 'pendiente' },
  { catalogo: '54', codigo: '005', descripcion: 'Maíz amarillo duro', tipoOperacionRelacionado: '1001', clasificacion: 'Bien', porcentajeNormativo: 4, tipoPorcentaje: 'fijo', afectacionesCompatibles: ['gravado'], visible: true, activo: true, implementacion: 'pendiente' },
  { catalogo: '54', codigo: '007', descripcion: 'Caña de azúcar', tipoOperacionRelacionado: '1001', clasificacion: 'Bien', porcentajeNormativo: 10, tipoPorcentaje: 'fijo', afectacionesCompatibles: ['gravado'], visible: true, activo: true, implementacion: 'pendiente' },
  { catalogo: '54', codigo: '008', descripcion: 'Madera', tipoOperacionRelacionado: '1001', clasificacion: 'Bien', porcentajeNormativo: 4, tipoPorcentaje: 'fijo', afectacionesCompatibles: ['gravado'], visible: true, activo: true, implementacion: 'pendiente' },
  { catalogo: '54', codigo: '009', descripcion: 'Arena y piedra', tipoOperacionRelacionado: '1001', clasificacion: 'Bien', porcentajeNormativo: 10, tipoPorcentaje: 'fijo', afectacionesCompatibles: ['gravado'], visible: true, activo: true, implementacion: 'pendiente' },
  { catalogo: '54', codigo: '010', descripcion: 'Residuos, subproductos, desechos, recortes y desperdicios', tipoOperacionRelacionado: '1001', clasificacion: 'Bien', porcentajeNormativo: 15, tipoPorcentaje: 'fijo', afectacionesCompatibles: ['gravado'], visible: true, activo: true, implementacion: 'pendiente' },
  { catalogo: '54', codigo: '011', descripcion: 'Bienes gravados con el IGV, o renuncia a la exoneración', tipoOperacionRelacionado: '1001', clasificacion: 'Bien', porcentajeNormativo: 10, tipoPorcentaje: 'fijo', afectacionesCompatibles: ['gravado'], visible: true, activo: true, implementacion: 'pendiente' },
  { catalogo: '54', codigo: '012', descripcion: 'Intermediación laboral y tercerización', tipoOperacionRelacionado: '1001', clasificacion: 'Servicio', porcentajeNormativo: 12, tipoPorcentaje: 'fijo', afectacionesCompatibles: ['gravado'], visible: true, activo: true, implementacion: 'pendiente' },
  { catalogo: '54', codigo: '013', descripcion: 'Animales vivos', tipoOperacionRelacionado: '1001', clasificacion: 'Bien', porcentajeNormativo: 4, tipoPorcentaje: 'fijo', afectacionesCompatibles: ['gravado'], visible: true, activo: true, implementacion: 'pendiente' },
  { catalogo: '54', codigo: '014', descripcion: 'Carnes y despojos comestibles', tipoOperacionRelacionado: '1001', clasificacion: 'Bien', porcentajeNormativo: 4, tipoPorcentaje: 'fijo', afectacionesCompatibles: ['gravado'], visible: true, activo: true, implementacion: 'pendiente' },
  { catalogo: '54', codigo: '015', descripcion: 'Abonos, cueros y pieles de origen animal', tipoOperacionRelacionado: '1001', clasificacion: 'Bien', porcentajeNormativo: 10, tipoPorcentaje: 'fijo', afectacionesCompatibles: ['gravado'], visible: true, activo: true, implementacion: 'pendiente' },
  { catalogo: '54', codigo: '016', descripcion: 'Aceite de pescado', tipoOperacionRelacionado: '1001', clasificacion: 'Bien', porcentajeNormativo: 10, tipoPorcentaje: 'fijo', afectacionesCompatibles: ['gravado'], visible: true, activo: true, implementacion: 'pendiente' },
  { catalogo: '54', codigo: '017', descripcion: 'Harina, polvo y "pellets" de pescado, crustáceos, moluscos y demás invertebrados acuáticos', tipoOperacionRelacionado: '1002', clasificacion: 'Recurso hidrobiológico', porcentajeNormativo: 4, tipoPorcentaje: 'fijo', afectacionesCompatibles: ['gravado'], visible: true, activo: true, implementacion: 'pendiente' },
  { catalogo: '54', codigo: '019', descripcion: 'Arrendamiento de bienes muebles', tipoOperacionRelacionado: '1001', clasificacion: 'Servicio', porcentajeNormativo: 10, tipoPorcentaje: 'fijo', afectacionesCompatibles: ['gravado'], visible: true, activo: true, implementacion: 'pendiente' },
  { catalogo: '54', codigo: '020', descripcion: 'Mantenimiento y reparación de bienes muebles', tipoOperacionRelacionado: '1001', clasificacion: 'Servicio', porcentajeNormativo: 12, tipoPorcentaje: 'fijo', afectacionesCompatibles: ['gravado'], visible: true, activo: true, implementacion: 'pendiente' },
  { catalogo: '54', codigo: '021', descripcion: 'Movimiento de carga', tipoOperacionRelacionado: '1001', clasificacion: 'Servicio', porcentajeNormativo: 10, tipoPorcentaje: 'fijo', afectacionesCompatibles: ['gravado'], visible: true, activo: true, implementacion: 'pendiente' },
  { catalogo: '54', codigo: '022', descripcion: 'Otros servicios empresariales', tipoOperacionRelacionado: '1001', clasificacion: 'Servicio', porcentajeNormativo: 12, tipoPorcentaje: 'fijo', afectacionesCompatibles: ['gravado'], visible: true, activo: true, implementacion: 'pendiente' },
  { catalogo: '54', codigo: '023', descripcion: 'Leche', tipoOperacionRelacionado: '1001', clasificacion: 'Bien', porcentajeNormativo: 4, tipoPorcentaje: 'fijo', afectacionesCompatibles: ['gravado'], visible: true, activo: true, implementacion: 'pendiente' },
  { catalogo: '54', codigo: '024', descripcion: 'Comisión mercantil', tipoOperacionRelacionado: '1001', clasificacion: 'Servicio', porcentajeNormativo: 10, tipoPorcentaje: 'fijo', afectacionesCompatibles: ['gravado'], visible: true, activo: true, implementacion: 'pendiente' },
  { catalogo: '54', codigo: '025', descripcion: 'Fabricación de bienes por encargo', tipoOperacionRelacionado: '1001', clasificacion: 'Servicio', porcentajeNormativo: 10, tipoPorcentaje: 'fijo', afectacionesCompatibles: ['gravado'], visible: true, activo: true, implementacion: 'pendiente' },
  { catalogo: '54', codigo: '026', descripcion: 'Servicio de transporte de personas', tipoOperacionRelacionado: '1003', clasificacion: 'Transporte pasajeros', porcentajeNormativo: 10, tipoPorcentaje: 'fijo', afectacionesCompatibles: ['gravado'], visible: true, activo: true, implementacion: 'pendiente' },
  { catalogo: '54', codigo: '027', descripcion: 'Servicio de transporte de carga', tipoOperacionRelacionado: '1004', clasificacion: 'Transporte carga', porcentajeNormativo: 4, tipoPorcentaje: 'fijo', afectacionesCompatibles: ['gravado'], visible: true, activo: true, implementacion: 'pendiente' },
  { catalogo: '54', codigo: '028', descripcion: 'Transporte de pasajeros', tipoOperacionRelacionado: '1003', clasificacion: 'Transporte pasajeros', porcentajeNormativo: 10, tipoPorcentaje: 'fijo', afectacionesCompatibles: ['gravado'], visible: true, activo: true, implementacion: 'pendiente' },
  { catalogo: '54', codigo: '030', descripcion: 'Contratos de construcción', tipoOperacionRelacionado: '1001', clasificacion: 'Construcción', porcentajeNormativo: 4, tipoPorcentaje: 'fijo', afectacionesCompatibles: ['gravado'], visible: true, activo: true, implementacion: 'pendiente' },
  { catalogo: '54', codigo: '031', descripcion: 'Oro gravado con el IGV', tipoOperacionRelacionado: '1001', clasificacion: 'Bien', porcentajeNormativo: 10, tipoPorcentaje: 'fijo', afectacionesCompatibles: ['gravado'], visible: true, activo: true, implementacion: 'pendiente' },
  { catalogo: '54', codigo: '032', descripcion: 'Paprika y otros frutos de los géneros capsicum o pimienta', tipoOperacionRelacionado: '1001', clasificacion: 'Bien', porcentajeNormativo: 10, tipoPorcentaje: 'fijo', afectacionesCompatibles: ['gravado'], visible: true, activo: true, implementacion: 'pendiente' },
  { catalogo: '54', codigo: '034', descripcion: 'Minerales metálicos no auríferos', tipoOperacionRelacionado: '1001', clasificacion: 'Bien', porcentajeNormativo: 10, tipoPorcentaje: 'fijo', afectacionesCompatibles: ['gravado'], visible: true, activo: true, implementacion: 'pendiente' },
  { catalogo: '54', codigo: '035', descripcion: 'Bienes exonerados del IGV', tipoOperacionRelacionado: '1001', clasificacion: 'Bien', porcentajeNormativo: 1.5, tipoPorcentaje: 'fijo', afectacionesCompatibles: ['exonerado'], visible: true, activo: true, implementacion: 'pendiente' },
  { catalogo: '54', codigo: '036', descripcion: 'Oro y demás minerales metálicos exonerados del IGV', tipoOperacionRelacionado: '1001', clasificacion: 'Bien', porcentajeNormativo: 1.5, tipoPorcentaje: 'fijo', afectacionesCompatibles: ['exonerado'], visible: true, activo: true, implementacion: 'pendiente' },
  { catalogo: '54', codigo: '037', descripcion: 'Demás servicios gravados con el IGV', tipoOperacionRelacionado: '1001', clasificacion: 'Servicio', porcentajeNormativo: 12, tipoPorcentaje: 'fijo', afectacionesCompatibles: ['gravado'], visible: true, activo: true, implementacion: 'pendiente' },
  { catalogo: '54', codigo: '039', descripcion: 'Minerales no metálicos', tipoOperacionRelacionado: '1001', clasificacion: 'Bien', porcentajeNormativo: 10, tipoPorcentaje: 'fijo', afectacionesCompatibles: ['gravado'], visible: true, activo: true, implementacion: 'pendiente' },
  { catalogo: '54', codigo: '040', descripcion: 'Bien inmueble gravado con IGV', tipoOperacionRelacionado: '1001', clasificacion: 'Bien inmueble', porcentajeNormativo: 4, tipoPorcentaje: 'fijo', afectacionesCompatibles: ['gravado'], visible: true, activo: true, implementacion: 'pendiente' },
  { catalogo: '54', codigo: '041', descripcion: 'Plomo', tipoOperacionRelacionado: '1001', clasificacion: 'Bien', porcentajeNormativo: 15, tipoPorcentaje: 'fijo', afectacionesCompatibles: ['gravado'], visible: true, activo: true, implementacion: 'pendiente' },
  { catalogo: '54', codigo: '044', descripcion: 'Servicio de beneficio de minerales metálicos gravado con el IGV', tipoOperacionRelacionado: '1001', clasificacion: 'Servicio', porcentajeNormativo: 12, tipoPorcentaje: 'fijo', afectacionesCompatibles: ['gravado'], visible: true, activo: true, implementacion: 'pendiente' },
  { catalogo: '54', codigo: '045', descripcion: 'Minerales de oro y sus concentrados gravados con el IGV', tipoOperacionRelacionado: '1001', clasificacion: 'Bien', porcentajeNormativo: 10, tipoPorcentaje: 'fijo', afectacionesCompatibles: ['gravado'], visible: true, activo: true, implementacion: 'pendiente' },
  { catalogo: '54', codigo: '099', descripcion: 'Ley 30737', tipoOperacionRelacionado: '1001', clasificacion: 'Especial', porcentajeNormativo: null, tipoPorcentaje: 'pendiente', notaPorcentaje: 'Validar tratamiento normativo específico de Ley 30737 antes de usar en emisión.', afectacionesCompatibles: ['gravado'], visible: true, activo: true, implementacion: 'pendiente' },
];
