...
export const SUNAT_DOCUMENT_TYPES: DocumentType[] = [
  ...
  // Recibo de Cobranza (documento interno de cobranza)
  {
    id: 'RC',
    code: 'RC',
  ...
  // Orden de Venta (documento interno)
  {
    id: 'OV',
    code: 'OV',
    name: 'Orden de Venta',
  ...
  // Orden de Compra (documento interno de compras)
  {
    id: 'OC',
    code: 'OC',
