...
const reviveCompany = (company: Company): Company => {
  ...
  return {
    ...company,
    tipoEmpresa: company.tipoEmpresa ?? obtenerTipoEmpresa(company),
...
export async function inicializarEmpresaEnAlmacenamiento({
  ...
  const resultadoConfiguracion = construirConfiguracionInicialEmpresa({
    ...
    datos: {
      direccionFiscal: datos.direccionFiscal,
      ubigeo: datos.ubigeo,
      entornoSunat: datos.entornoSunat,
...
export function ConfigurationProvider({ children, tenantIdOverride }: ConfigurationProviderProps) {
  ...
  useEffect(() => {
    ...
    const datosWorkspace = {
      id: tenantId,
      tipoEmpresa: state.company.tipoEmpresa ?? obtenerTipoEmpresa(state.company),
  ...
  useEffect(() => {
    ...
    const empresaNormalizada: Company = {
      ...empresa,
      id: tenantId,
      tipoEmpresa: empresa.tipoEmpresa ?? obtenerTipoEmpresa(empresa),
    };
