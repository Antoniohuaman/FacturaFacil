...
export const getVoucherTypeFromSeries = (
  ...
  if (series.documentType.code === 'OV' || series.documentType.name.includes('Orden de Venta')) {
    return 'SALE_ORDER';
  }
  ...
  if (series.documentType.code === 'OC' || series.documentType.name.includes('Orden de Compra')) {
