...
import CreditScheduleEditor from '@/features/configuracion-sistema/components/business/CreditScheduleEditor';
import type { PaymentMethod } from '@/features/configuracion-sistema/models/PaymentMethod';
