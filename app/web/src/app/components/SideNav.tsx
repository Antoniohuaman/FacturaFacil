...
const mainItems = [
  ...
  { to: "/catalogo", label: "Productos", icon: (
    ...
    <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24"><rect x="3" y="7" width="18" height="13" rx="2" /><path d="M16 3v4M8 3v4M3 10h18" /></svg>
  ) },
  { to: "/lista-precios", label: "Precios", icon: (
