...
const ListaNotasVenta = () => {
  ...
  const facturadas = filteredDocs.filter(doc => doc.status === 'Facturado').length;
  ...
  const getStatusBadge = (status: string) => {
    const configs: Record<string, { color: string; bg: string }> = {
      ...
      'Anulado': { color: 'text-gray-800 dark:text-gray-200', bg: 'bg-gray-100 dark:bg-gray-900/40 border-gray-300' }
    };
        ...
        <div className="px-6 py-4">
          <div className="flex items-center gap-3">
            ...
            <button 
              ...
              onClick={() => navigate('/documentos/nota-venta/nueva')}
            >
                    ...
                    <td colSpan={9} className="px-6 py-16 text-center">
                      <div className="flex flex-col items-center justify-center">
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">
                          No hay notas de venta en el rango de fechas seleccionado. Intenta ajustar los filtros de fecha.
                        </p>
                        <button 
            ...
            <div className="flex items-center gap-4">
              ...
              {showTotals && (
                <div className="flex items-center gap-4 text-sm">
                  ...
                  <span className="text-gray-600 dark:text-gray-400">
                    Facturadas: <span className="font-semibold">{facturadas}</span>
                  </span>
                </div>
              )}
            </div>
