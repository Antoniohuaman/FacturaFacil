      ...
      <div className="flex flex-col lg:flex-row lg:items-center gap-6 lg:gap-8">
        <div className="flex-1 order-2 lg:order-1">
          {hasData ? (
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">No hay comprobantes registrados en este periodo.</p>
          )}
        </div>
        ...
        <div className="w-full max-w-[14.78rem] h-[14.78rem] mx-auto lg:mx-0 flex items-center justify-center order-1 lg:order-2 mt-3 relative">
          {hasData ? (
            ...
            <div className="text-sm text-gray-500 dark:text-gray-400 text-center px-4">
              Sin datos por tipo de comprobante.
              <div className="mt-2 text-xs text-gray-400 dark:text-gray-500">
                Total de ventas: {formatCurrency(totalVentasPeriodo)}
              </div>
            </div>
          )}
        </div>
