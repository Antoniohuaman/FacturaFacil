...
export const ANALYTICS_EVENTS = {
  ...
  FLUJO_VENTA_ABANDONADO: 'flujo_venta_abandonado',
  COMPROBANTE_ESTADO_ACTUALIZADO: 'comprobante_estado_actualizado',
  AYUDA_CONSULTADA: 'ayuda_consultada',
  BORRADOR_ACCION_REALIZADA: 'borrador_accion_realizada',
