...
export const onRequestGet = async (context: ContextoRetroalimentacionPanelV1): Promise<Response> => {
  ...
  try {
    ...
    const bloqueoOperativo = validarHabilitacionPanelRetroalimentacionV1(context.env, requestId)
    ...
    const alcanceEmpresas = resolverAlcanceEmpresaPanelV1(filtros, consumidor)
    ...
    const respuesta = construirRespuestaPanelV1(
